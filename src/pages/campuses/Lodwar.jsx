...
import { Mountain, Sun, Users, BookOpen, Wrench, Trophy, Phone, MessageCircle, MapPin, Mail } from 'lucide-react';
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  <div>
                    ...
                    <ul className="space-y-2 text-gray-600">
                      <li>• Water scarcity and management</li>
                      <li>• Climate change adaptation</li>
                      <li>• Limited infrastructure development</li>
                  ...
                  <div>
                    ...
                    <ul className="space-y-2 text-gray-600">
                      ...
                      <li>• Sustainable technology education</li>

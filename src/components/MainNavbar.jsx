...
//                 <img src={logo} alt="AIRADS College Logo" className="h-20 md:h-24 w-auto flex-shrink-0" />
//                 <div className="block">
//                   <h1 className="institute-font text-red-600 text-sm md:text-base lg:text-xl leading-tight">
//                     AFRICAN INSTITUTE <br/>
//                     <span className="text-blue-700 text-xs md:text-sm lg:text-base" style={{ fontFamily: "'Staatliches', cursive" }}>
...
//             {/* Desktop Navigation Menu - Compact in remaining space */}
//             <div className="hidden lg:flex items-center justify-end space-x-1 xl:space-x-2 flex-wrap">
//               <Link to="/" className="text-gray-700 hover:text-blue-600 font-medium transition-colors text-xs whitespace-nowrap py-1 px-1">
//                 Home
//               </Link>
...
//               >
//                 <button className="flex items-center text-gray-700 hover:text-blue-600 font-medium transition-colors text-xs py-1 px-1 whitespace-nowrap">
...
//               <Link to="/students" className="text-gray-700 hover:text-blue-600 font-medium transition-colors text-xs whitespace-nowrap py-1 px-1">
//                 Students
//               </Link>

//               {/* Contact Dropdown - Fixed positioning */}
//               <div
//                 className="relative"
...
//                     School of Hospitality and Tourism MGT
//                   </Link>
//                   <Link to="/schools/health-social" onClick={closeMobileMenu} className="block py-2 px-4 text-gray-600 hover:bg-blue-50 hover:text-blue-600 rounded-colors">
//                     School of Health and Social Sciences
//                   </Link>
              ...
              >
                ...
                {openDropdown === 'admissions' && (
                  ...
                  >
                    ...
                    <a href="https://admissions.airads.ac.ke/" className="block px-4 py-3 text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition-colors">
                      Apply Online
                    </a>
                    <Link to="/admissions/career-guide" className="block px-4 py-3 text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition-colors">
                      Career Guide & Prospectus
